...
CREATE TABLE IF NOT EXISTS `evenement` (
  ...
  PRIMARY KEY (`ID_EVE`),
  KEY `EVENEMENT_STRUCTURE_FK` (`ID_STRUCTURE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `specialisee` (
  `SECTEUR` varchar(255) NOT NULL,
  `ID_STRUCTURE` int(11) NOT NULL,
  PRIMARY KEY (`SECTEUR`,`ID_STRUCTURE`),
  KEY `SPECIALISEE_STRUCTURE0_FK` (`ID_STRUCTURE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `structure` (
  ...
  `TEL_STRUCTURE` varchar(255) NOT NULL,
  `VILLE` varchar(255) NOT NULL,
  `ADRESSE` varchar(255) NOT NULL,
  `CODE_POSTALE` varchar(255) NOT NULL,
  `TAILLE_STRUCTURE` int(11) NOT NULL,
...
ALTER TABLE `evenement`
  ADD CONSTRAINT `EVENEMENT_STRUCTURE_FK` FOREIGN KEY (`ID_STRUCTURE`) REFERENCES `structure` (`ID_STRUCTURE`);
...
ALTER TABLE `represente`
  ...
  ADD CONSTRAINT `REPRESENTE_STRUCTURE_FK` FOREIGN KEY (`ID_STRUCTURE`) REFERENCES `structure` (`ID_STRUCTURE`);
...
ALTER TABLE `specialisee`
  ...
  ADD CONSTRAINT `SPECIALISEE_STRUCTURE0_FK` FOREIGN KEY (`ID_STRUCTURE`) REFERENCES `structure` (`ID_STRUCTURE`);
COMMIT;
